...
class PostPagesTests(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.small_gif = settings.TEST_IMAGE
    ...
    def test_post_group_posts_show_correct_context(self):
        response = self.guest_client.get(
    ...
    def test_post_post_edit_show_correct_context(self):
    ...
    def test_post_post_exists_on_pages_and_not_dublicated(self):
        value = 'test-slug'
        dict_names = {
    ...
    def test_post_post_has_img_in_context(self):
        template_names = (
            reverse(ADD_INDEX),
            reverse(
                PostPagesTests.ADD_PROFILE,
    ...
    def test_post_index_page_cashe(self):
    ...
    def test_post_auth_user_follow_and_track_feed(self):
    ...
    def test_post_auth_user_unfollow(self):
        self.a_user_client = Client()
        self.a_user_client.force_login(self.a_user)
        self.a_user_client.get(
            reverse(
    ...
    def test_post_post_appearance_in_feed(self):
        post = Post.objects.create(
            text='text_test',
            author=self.user,
        )
...
class PostPaginatorTests(TestCase):
    ...
    def test_post_first_page_contains_ten_obj(self):
    ...
    def test_post_second_page_contains_four_obj(self):
        qty = 3
        pages = {
